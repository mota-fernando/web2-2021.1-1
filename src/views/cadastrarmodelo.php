...
<body class="bg-secondary">
    <div class="container">
        <h1 class="display-1 text-center text-light">Cadastrar Modelo do Veiculo</h1>
        ...
        <form class='form' action="./cadastrarmodelo.php" method="POST">
            <div class="mb-3"><br>
                ...
                <label for="descricao" class="form-label text-light">Modelo do Veiculo</label>
...
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                          Esse modelo , ja esta cadastrado;
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>';
}
}
