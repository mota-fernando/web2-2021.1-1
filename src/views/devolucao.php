    ...
    <div class="container">
        ...
        <table class="table table-striped" id="table">
            ...
            foreach ($devolucaos->findAll() as $devolucao) {
                $x = $aluguels->findOne($devolucao->getidaluguel());
                $c = $clientes->findOne($x->getidcliente());
                $v = $veiculos->findOneAlu($devolucao->getidaluguel());  ?>
                <tr class=" text-light">

                    <td> <?= "R$ ",$devolucao->gettotal() ?> </td>
                    <td> <?= "R$ ",$devolucao->getextra() ?> </td>
                    <td> <?= $c->getnome() ?> </td>
                    <td> <?= $v->getnome() ?> </td>
                    <td> <?= $devolucao->getdatadevolucao() ?> </td>

                    <td> <?= $devolucao->getpag() ?> </td>
